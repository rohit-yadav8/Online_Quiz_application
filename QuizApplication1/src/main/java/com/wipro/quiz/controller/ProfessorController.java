...
public class ProfessorController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(buttonTrigger.equals("addQues")) {
		    ...
		    // Allow only 10 questions per topic
		    List<QuestionsBean> existingQuestions = service.getQuesList(topic);
		    if (existingQuestions != null && existingQuestions.size() >= 10) {
		        out.println("<Script  type=\"text/javascript\">");
		        out.println("alert('Only 10 questions allowed per topic.');");
